...
from app.core.rag.embeddings import get_ollama_embeddings
...
async def ingest(texts):
    try:
        ...
        async with AsyncSessionFactory() as session:
            await store_documents(session, texts, embeddings)
